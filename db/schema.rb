...
ActiveRecord::Schema.define(version: 20150703214259) do
  ...
  add_index "invitations", ["invitation_token_id"], name: "index_invitations_on_invitation_token_id", using: :btree
